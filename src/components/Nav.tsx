...
export function Nav({ lang, onToggle }: NavProps) {
  return (
      ...
      <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden items-center gap-1.5 text-sm text-zinc-500 transition-colors hover:text-zinc-900 sm:flex dark:text-zinc-400 dark:hover:text-white"
          >
