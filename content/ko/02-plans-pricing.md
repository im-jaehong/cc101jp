...
> 아래 가격은 **2026년 8월 기준**입니다. 최신 가격은 [claude.com/pricing](https://claude.com/pricing)에서 확인하세요.

| | **Pro** | **Max (5x)** | **Max (20x)** |
|---|---|---|---|
| **월 가격** | $20 (연간 결제 시 $17) | $100 | $200 |
...
> **무료(Free) 플랜에서는 Claude Code를 쓸 수 없습니다.** Pro, Max, Team, Enterprise 또는 Console(API) 계정이 필요합니다.
>
> 팀 단위라면 **Team**(좌석당 월 $25, 연간 결제 시 $20)이나 **Enterprise**(별도 문의)도 Claude Code를 포함합니다.
...
공식 문서(2026년 8월 기준)에 따르면, API 사용자의 평균 비용은 **개발자 1인당 사용한 날 하루 약 $13, 월 $150~$250** 수준이며, 사용자의 90%는 하루 $30 이하입니다 (사용 강도에 따라 차이 큼).
...
- `/usage` 명령어로 현재 세션 비용 확인 가능 (`/cost`는 `/usage`의 별칭)
...
- Agent Teams(여러 AI를 동시에 실행) 기능은 토큰 소모가 약 **7배** 많습니다. 현재 **실험 기능이며 기본적으로 꺼져 있습니다** (`CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1` 설정 시 활성화).
